                        ...
                        <div className="flex flex-row">
                            <div className="form-control mt-2 ">
                                <label className="label cursor-pointer">
                                    ...
                                    <input type="radio" name="gender" className="radio checked:bg-gray-500 ml-5" checked={inputs.gender === 'male'} onChange={handleEvent} value="male" />
                                </label>
                            </div>
                            <div className="form-control mt-2">
                                <label className="label cursor-pointer">
                                    <span className="label-text">Female  </span>
                                    <input type="radio" name="gender" className="radio checked:bg-gray-500 ml-3" checked={inputs.gender === 'female'} onChange={handleEvent} value='female' />
                                </label>
                            </div>
                        </div>
                        <div>
                            <button className="btn btn-wide mt-7" onClick={handleSubmit} disabled={loading} >Signup</button>
